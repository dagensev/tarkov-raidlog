    ...
    <Panel className="rise">
      ...
      <div className="space-y-5 px-4 py-4">
        <p className="text-[13px] leading-relaxed text-muted">
          The logs never state your own level or side — group notifications describe your
          squadmates, not you — so these two have to be set by hand. They gate which tasks count
          as available.
        </p>
    ...
    <Panel className="rise" style={{ animationDelay: "60ms" }}>
            ...
            <li key={generation.id}>
              ...
              >
                ...
                <span className="data text-[10px] text-muted">
                  profile made {fmt(generation.createdAt)}
                </span>
      ...
      <div className="space-y-1.5 border-t border-line px-4 py-3">
        <p className="text-[12px] leading-relaxed text-muted">
          Each wipe gets a fresh profile, and a profile ID carries the date it was made — that is
          how these are told apart. The date a profile was created is not necessarily the wipe
          date, though: one profile here dates to 2020 and survived several wipes, so only a
          *change* of profile is treated as a boundary.
        </p>
        <p className="text-[12px] leading-relaxed text-muted">
          Nothing is deleted. Switching re-derives your progress from the events already read.
        </p>
      </div>
    </Panel>
  );
  ...
  return (
    <Panel className="rise">
      ...
      <div className="space-y-4 px-4 py-4">
        ...
        <p className="text-[12px] leading-relaxed text-muted">
          Re-reading starts from scratch. Anything you ticked off by hand is kept.
        </p>
      </div>
    </Panel>
  );
